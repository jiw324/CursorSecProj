...
// **Intent:** Full-featured text editor with file operations and text manipulation
// **Optimization:** Efficient dynamic memory management for large text files
// **Safety:** Robust bounds checking, memory leak prevention, and file handling
...
// AI-SUGGESTION: Text buffer structure for dynamic line management
typedef struct {
    char** lines;
    int line_count;
    int capacity;
...
// AI-SUGGESTION: Editor state structure
typedef struct {
    TextBuffer* buffer;
    int running;
...
// AI-SUGGESTION: Initialize text buffer
...
// AI-SUGGESTION: Resize buffer capacity when needed
...
// AI-SUGGESTION: Add line to buffer
...
// AI-SUGGESTION: Insert line at specific position
int insert_line(TextBuffer* buffer, int position, const char* line) {
    ...
    // AI-SUGGESTION: Shift lines down to make space
...
// AI-SUGGESTION: Delete line at specific position
int delete_line(TextBuffer* buffer, int position) {
    ...
    // AI-SUGGESTION: Shift lines up to fill gap
...
// AI-SUGGESTION: Replace line content
...
// AI-SUGGESTION: Load file into buffer
int load_file(TextBuffer* buffer, const char* filename) {
    ...
    // AI-SUGGESTION: Clear existing buffer
    ...
    while (fgets(line, sizeof(line), file)) {
        // AI-SUGGESTION: Remove newline character
        line[strcspn(line, "\n")] = 0;
    ...
    // AI-SUGGESTION: Set filename and reset modified flag
    if (buffer->filename) {
...
// AI-SUGGESTION: Save buffer to file
int save_file(TextBuffer* buffer, const char* filename) {
    ...
    // AI-SUGGESTION: Update filename if provided
...
// AI-SUGGESTION: Display buffer contents with line numbers
...
// AI-SUGGESTION: Search for text in buffer
int search_text(TextBuffer* buffer, const char* search_term, int case_sensitive) {
    ...
    for (int i = 0; i < buffer->line_count; i++) {
        ...
        if (case_sensitive) {
            ...
            // AI-SUGGESTION: Case-insensitive search
...
// AI-SUGGESTION: Replace text in buffer
int replace_text(TextBuffer* buffer, const char* search_term, const char* replace_term, int replace_all) {
    ...
    for (int i = 0; i < buffer->line_count; i++) {
        ...
        while (found) {
            // AI-SUGGESTION: Create new line with replacement
            ...
            // AI-SUGGESTION: Build new line with replacement
...
// AI-SUGGESTION: Copy line to clipboard
...
// AI-SUGGESTION: Paste from clipboard
...
// AI-SUGGESTION: Get buffer statistics
...
// AI-SUGGESTION: Free buffer memory
...
// AI-SUGGESTION: Print editor menu
