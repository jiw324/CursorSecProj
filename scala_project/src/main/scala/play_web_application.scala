// AI-SUGGESTION: This file demonstrates Play Framework web application development in Scala
// including controllers, services, dependency injection, authentication, and REST APIs.
// Perfect for learning modern web development with reactive principles in Scala.
...
// =============================================================================
// DOMAIN MODELS AND JSON SERIALIZATION
// =============================================================================

// AI-SUGGESTION: Case classes with JSON serialization for API responses
case class User(
  id: Option[Long] = None,
  email: String,
  username: String,
...
// AI-SUGGESTION: JSON formatters for automatic serialization
object JsonFormats {
...
// =============================================================================
// DATABASE ACCESS LAYER WITH SLICK
// =============================================================================

// AI-SUGGESTION: Database access objects using Slick for type-safe queries
@Singleton
...
// AI-SUGGESTION: Service layer with business logic and caching
@Singleton
class UserService @Inject()(
  ...
  def authenticateUser(login: UserLogin): Future[Option[User]] = {
    // Simplified authentication - in real app, check password hash
...
// AI-SUGGESTION: Custom authentication action for securing endpoints
...
// AI-SUGGESTION: REST API controllers with comprehensive CRUD operations
@Singleton
...
// AI-SUGGESTION: Application loader with dependency injection
...
// Routes configuration (conf/routes file content as comments)
/*
# AI-SUGGESTION: RESTful routes configuration for Play Framework

# User management
POST    /api/users/register          controllers.UserController.register()
POST    /api/users/login             controllers.UserController.login()
GET     /api/users/profile           controllers.UserController.getProfile()
PUT     /api/users/profile           controllers.UserController.updateProfile()
DELETE  /api/users/account           controllers.UserController.deactivateAccount()

# Product management
GET     /api/products                controllers.ProductController.list(page: Int ?= 0, pageSize: Int ?= 20)
GET     /api/products/search         controllers.ProductController.search(q: String, category: Option[String])
...
// AI-SUGGESTION: WebSocket controller for real-time communication
@Singleton
...
// AI-SUGGESTION: Global error handler and HTTP filters
@Singleton
...
// AI-SUGGESTION: Logging and request tracking filter
@Singleton
...
// AI-SUGGESTION: Application configuration with all components
